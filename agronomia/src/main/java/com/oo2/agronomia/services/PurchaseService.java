...
public class PurchaseService {
    ...
    public Purchase addPurchase(String paymentMethod, User client, List<Product> productList, PurchaseStrategy strat) {
        Purchase newPurchase = new Purchase(paymentMethod, client, productList, strat);
