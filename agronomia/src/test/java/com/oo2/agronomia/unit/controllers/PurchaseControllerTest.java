...
public class PurchaseControllerTest {
    ...
    void getAllPurchases() throws Exception {
        ...
        purchases.add(new Purchase("payment1", user1, productList));
        purchases.add(new Purchase("payment2", user2, productList));
    ...
    void addNewPurchaseTest() throws Exception {
        ...
        Purchase newPurchase = new Purchase("payment1", newUser, productList);

        when(purchaseService.addPurchase(newPurchase.getPaymentMethod(), newPurchase.getClient(), productList))
